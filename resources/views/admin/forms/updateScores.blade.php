        ...
        <div class="row">
          <br/>
            <div class="col-lg-offset-3 col-lg-6">
              ...
              <div class="panel-heading"><?= $gameInfo->game_status == 'played' ? 'Re-' : ''; ?>Update Scores : <b>{{ $gameInfo->home_team }}</b> vs <b>{{ $away_team }}</b></div>
              <div class="panel-body">
                <!-- form -->


                <form class="form-horizontal" action="/admin/finalize/update/scores" method="post">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <select class="form-control" id="away_score" name="away_score">
