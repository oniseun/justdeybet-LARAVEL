 ...
 <div class="row">
          <br/>
            <div class="col-lg-offset-2 col-lg-8">
              ...
              <div class="panel-heading"><b>Add Admin </b></div>
              <div class="panel-body">
                <!-- form -->

                <form class="form-horizontal" class="reset-on-success"sss action="/admin/finalize/add/admin" method="post">
                    @csrf
                  ...
                  <hr/>
                  <h3> Admin Permissions <small>default selected</small></h3><br/>
                  <div class="form-group">
                  ...
                  <div class="form-group ">
                    <div class="col-sm-offset-3 col-sm-9">
                      ...
                      <button type="submit" class="btn btn-primary ajax-submit">Submit Admin</button>
                    </div>
                  </div>
